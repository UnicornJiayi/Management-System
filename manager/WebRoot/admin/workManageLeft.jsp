...
<script type="text/javascript" >
	...
	function rightLoadadd(){
		$(".aFB_b_right").load("deletework.jsp");
		return false;
	}
...
<div>
	<div class="operlist" onclick="showChild(this,'1');"><a class="child" href="#" >+</a>删除作业</div>
		<div id="child1" > 
			<a href="#" class="items" id="classadd" onclick="rightLoadadd();" style="margin-left: 30px">删除作业</a> <br /> 
