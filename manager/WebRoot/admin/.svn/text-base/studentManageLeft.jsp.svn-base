...
<script type="text/javascript" >
	...
	function rightLoadadd(){
		$(".aFB_b_right").load("selectpassword.jsp");
		return false;
	}
...
<div>
	<div class="operlist" onclick="showChild(this,'1');"><a class="child" href="#" >+</a>学生管理</div>
		<div id="child1" > 
			<a href="#" class="items" id="classadd" onclick="rightLoadadd();" style="margin-left: 30px">找回密码</a> <br /> 
			<div style="height: 6px;"></div>
			<a href="#" class="items" id="classcheck" onclick="rightLoadselect();">删除学生</a> 
		</div> 
</div>